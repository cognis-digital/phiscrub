#!/usr/bin/env sh
# Universal installer for phiscrub. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/phiscrub.git"
echo "Installing phiscrub ..."
